...
import ykk.xc.com.glswms.sales.adapter.Sal_Sel_SalOrder_DialogAdapter
 ...
 * 选择销售订单dialog
 */
class Sal_Sel_SalOrder_Dialog : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private var mAdapter: Sal_Sel_SalOrder_DialogAdapter? = null
...
//    private var fcustId = 0 // 客户id
    ...
    private class MyHandler(activity: Sal_Sel_SalOrder_Dialog) : Handler() {
        private val mActivity: WeakReference<Sal_Sel_SalOrder_Dialog>
    ...
    override fun initView() {
        ...
        mAdapter = Sal_Sel_SalOrder_DialogAdapter(context, listDatas)
