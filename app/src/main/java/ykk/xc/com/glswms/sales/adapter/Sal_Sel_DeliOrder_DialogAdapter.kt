...
class Sal_Sel_DeliOrder_DialogAdapter(private val context: Activity, private val datas: List<SeOutStockEntry_App>) : BaseArrayRecyclerAdapter<SeOutStockEntry_App>(datas) {
    private val df = DecimalFormat("#.######")
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.sal_sel_deli_order_dialog_item
    }

    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: SeOutStockEntry_App, pos: Int) {
        // 初始化id
        ...
        tv_sourceNo.text = Html.fromHtml("发货单:&nbsp;<font color='#000000'>"+ entity.seOutStock.fbillNo+"</font>")
        tv_orderNo.text = Html.fromHtml("销售订单:&nbsp;<font color='#000000'>"+ entity.fsourceBillNo+"</font>")
        tv_custName.text = Html.fromHtml("客户:&nbsp;<font color='#6a5acd'>"+ entity.seOutStock.cust.fname+"</font>")
