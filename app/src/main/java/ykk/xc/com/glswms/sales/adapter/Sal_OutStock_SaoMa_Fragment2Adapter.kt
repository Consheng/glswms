...
class Sal_OutStock_SaoMa_Fragment2Adapter(private val context: Activity, datas: List<ICStockBillEntry_App>) : BaseArrayRecyclerAdapter<ICStockBillEntry_App>(datas) {
    private val df = DecimalFormat("#.######")
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.sal_out_stock_saoma_fragment2_item
    }
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: ICStockBillEntry_App, pos: Int) {
        ...
        tv_sourceQty.text = Html.fromHtml("发货单:&nbsp;<font color='#000000'>"+ entity.fsourceBillNo +"</font>（<font color='#6a5acd'>" + df.format(entity.fsourceQty) + "</font>&nbsp;<font>" + entity.unit.fname + "</font>）")
