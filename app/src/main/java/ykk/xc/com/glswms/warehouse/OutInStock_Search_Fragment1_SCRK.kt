...
import ykk.xc.com.glswms.warehouse.adapter.OutInStockSearchFragment1_SCRK_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment1_SCRK : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment1_SCRK_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment1_SCRK) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment1_SCRK>
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment1_SCRK_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment1_SCRK_Adapter.MyCallBack {
